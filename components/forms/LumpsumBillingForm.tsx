...
import { useLumpsumBillingImage } from "@/hooks/use-form-hook";
...
export type LumpsumBillingFormSchema = z.infer<typeof formSchema>;

const LumpsumBillingForm = () => {
  const { mutate } = useLumpsumBillingImage();
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    mutate(values, {
      onSuccess: (blob) => {
        ...
        a.href = url;
        a.download = "lumpsum-billing.png";
  ...
  const costForExtraKM = form.watch("cost_extra_km");
  const costForExtraHr = form.watch("cost_extra_hr");
  ...
  useEffect(() => {
    ...
    if (costForExtraKM && costForExtraHr) {
      form.setValue("total", costForExtraKM + costForExtraHr);
    }
...
export default LumpsumBillingForm;
