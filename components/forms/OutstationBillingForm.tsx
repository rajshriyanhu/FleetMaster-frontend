...
import {
  useLocalBillingImage,
  useOutstationBillingImage,
...
export type OutstationBillingFormSchema = z.infer<typeof formSchema>;

const OutstationBillingForm = () => {
  const { mutate } = useOutstationBillingImage();
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    mutate(values, {
      onSuccess: (blob) => {
        ...
        a.href = url;
        a.download = "outstation-billing.png";
  ...
  const totalKMBilling = form.watch("total_km_billing");
  ...
  useEffect(() => {
    ...
    if (extraKM && totalBilling) {
      form.setValue("total_km_billing", extraKM + totalBilling);
    }
...
export default OutstationBillingForm;
