...
import { useoutstationBookingImage } from "@/hooks/use-form-hook";
...
export type OutstationBookingFormSchema = z.infer<typeof formSchema>;

const OutstationBookingForm = () => {
  const { mutate } = useoutstationBookingImage();
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      days: undefined,
      total_billing: undefined,
      total_driver_allowance: undefined,
      total: undefined,
      start_location: "",
      end_location: "",
      location_visit: "",
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    mutate(values, {
      onSuccess: (blob) => {
        ...
        a.href = url;
        a.download = "outstation-booking.png";
