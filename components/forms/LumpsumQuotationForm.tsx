...
import { useLumpsumQuotationImage } from "@/hooks/use-form-hook";
...
export type LumpsumQuotationFormSchema = z.infer<typeof formSchema>;

const LumpsumQuotationForm = () => {
  const { mutate } = useLumpsumQuotationImage();
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    mutate(values, {
      onSuccess: (blob) => {
        ...
        a.href = url;
        a.download = "lumpsum-quotation.png";
  ...
  }, [startDate, endDate, capacity, form]);
...
export default LumpsumQuotationForm;
